...
| OER batch fda-pharm2e-001 | FDA Prescribing Information · Digoxin · Furosemide · Lisinopril · Warfarin · Insulin lispro labels | Public domain (17 U.S.C. §105) | https://dailymed.nlm.nih.gov/dailymed/services/v2/spls.json?drug_name=digoxin + https://api.fda.gov/drug/label.json | 30 | Source: FDA drug labels (US government work, public domain) | pending |  |  |
