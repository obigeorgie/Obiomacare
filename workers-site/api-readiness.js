...
function seedReadinessItems() {
  ...
  function add(item) {
    items.push({ ...item, id: String(id++), reviewStatus: 'approved', exposureCount: 0 });
  }
  ...
  add({ stem: 'A patient receiving morphine PCA reports nausea. Which PRN medication is MOST appropriate?', options: ['Ondansetron 4mg IV','Promethazine 25mg IM','Prochlorperazine 10mg PO','Metoclopramide 10mg IV'], correctIndex: 0, rationale: 'Ondansetron is first-line for opioid-induced nausea, especially post-op. Minimal sedation and no hypotension risk compared to promethazine.', category: 'pharmacology', difficulty: 0.45, ncjmmStep: 4, ngn: false, derivedFrom: 'quiz-pharm-q15', original: false });
  ...
  add({ stem: 'A patient with Crohn\'s disease has a new ileostomy. The output has been 1200mL in the past 8 hours. Which intervention is MOST important?', options: ['Apply a larger pouch','Start metronidazole for bacterial overgrowth','Increase oral intake to match output','Implement fluid replacement and electrolyte monitoring'], correctIndex: 3, rationale: 'High ileostomy output (>1000mL/8hr) risks dehydration and electrolyte imbalance (Na+, K+, Mg2+). Fluid replacement is critical. Antibiotics are not indicated without infection signs.', category: 'medical_surgical', difficulty: 0.70, ncjmmStep: 4, ngn: false, derivedFrom: null, original: true });
  ...
  // Fresh (3)
  add({ stem: 'A patient in preterm labor at 30 weeks is receiving betamethasone. The nurse should monitor for which ADVERSE effect that requires immediate intervention?', options: ['Hyperglycemia','Pulmonary edema','Fetal tachycardia','Maternal hypertension'], correctIndex: 0, rationale: 'Betamethasone can cause transient hyperglycemia, especially in patients with gestational diabetes. Blood glucose monitoring is essential. Pulmonary edema is atocolytic (terbutaline) complication, not steroid.', category: 'maternity', difficulty: 0.70, ncjmmStep: 1, ngn: false, derivedFrom: null, original: true });
  ...
  add({ stem: 'A patient on a 5150 hold asks when they can leave. The nurse should:', options: ['Explain the legal hold process and timeline','Tell them to ask the doctor','Say they can leave when they feel better','Avoid the topic to prevent agitation'], correctIndex: 0, rationale: 'Patients on involuntary holds have the right to understand their legal status. Clear, factual communication reduces anxiety and supports autonomy.', category: 'mental_health', difficulty: 0.45, ncjmmStep: 6, ngn: false, derivedFrom: 'guide-mental-health-rights', original: false });
  // Fresh (3)
