...
function seedReadinessItems() {
  ...
  // Derived (5)
  add({ stem: 'A nurse is assessing a patient post-op abdominal surgery. Which finding requires immediate notification of the provider?', options: ['Serous drainage on dressing','Pain rated 6/10 at incision site','Temperature 38.2°C (100.8°F)','Wound edges well-approximated'], correctIndex: 2, rationale: 'Post-op fever >38°C indicates possible infection or abscess formation. Pain and serous drainage are expected; well-approximated edges are normal.', category: 'fundamentals', difficulty: 0.35, ncjmmStep: 1, ngn: false, derivedFrom: 'quiz-lab-values-q3', original: false, reviewStatus: 'draft' });
